...
if __name__ == "__main__":
    ...
    url = "https://uk.reuters.com/news/world"
    url_response = urlopen(url)
    news_html = BeautifulSoup(url_response)

    update_url_list = []
    for news_class in news_html.find_all("div", class_="story-content"):
        #print(news_class)
        news_url = "https://uk.reuters.com" + news_class.find("a")["href"]
        #print(news_url)
    ...
    if os.path.exists("./reuters_news_url_tmp.txt"):
        with open("./reuters_news_url_tmp.txt", "r", encoding="utf-8") as f:
        ...
        if not url_list == []:
            ...
            with open("./reuters_news_url_tmp.txt", "w", encoding="utf-8") as f:
                for url in url_list:
                    f.write(str(url + "\n"))
